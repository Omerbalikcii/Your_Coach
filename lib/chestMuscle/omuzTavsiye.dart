...
class omuzTavsiye extends StatefulWidget {
  const omuzTavsiye({Key? key}) : super(key: key);

  @override
  State<omuzTavsiye> createState() => _omuzTavsiyeState();
}

class _omuzTavsiyeState extends State<omuzTavsiye> {
  @override
